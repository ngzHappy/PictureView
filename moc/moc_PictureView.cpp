/****************************************************************************
** Meta object code from reading C++ file 'PictureView.hpp'
**
...
#error "The header file 'PictureView.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 10), // "setPicture"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "PictureView\0setPicture\0"
};
...
void PictureView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setPicture((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject PictureView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_PictureView.data,
      qt_meta_data_PictureView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
