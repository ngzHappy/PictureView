/****************************************************************************
** Meta object code from reading C++ file 'PictureModel.hpp'
**
...
#error "The header file 'PictureModel.hpp' doesn't include <QObject>."
...
const QMetaObject PictureModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_PictureModel.data,
      qt_meta_data_PictureModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
